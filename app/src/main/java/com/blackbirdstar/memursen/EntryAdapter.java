...
public class EntryAdapter extends BaseAdapter {
    ...
    public EntryAdapter(Context mContext, List<Response.EntriesBean> entries) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //Picasso.with(mContext).load(imageUrl).networkPolicy(NetworkPolicy.OFFLINE).into(thumbnail);
